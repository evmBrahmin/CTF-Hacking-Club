...
contract SafuStrategy is Ownable, Pausable {
    ...
    // @audit this is an external function that can be called by anyone
    ...
    function withdraw(uint256 _amount) external {
        ...
        // @audit If total token balance is less than the amount requested, withdraw all
        // @audit The _amount var and wantBal var can be different 
